...
| Plugin | Description | Commands | Version |
|--------|-------------|----------|---------|
| [guided-dev](plugins/guided-dev/) | Structured development workflow with intake, clarification, planning, implementation, verification, and PR creation | `/guided-dev` | 2.0.0 |
